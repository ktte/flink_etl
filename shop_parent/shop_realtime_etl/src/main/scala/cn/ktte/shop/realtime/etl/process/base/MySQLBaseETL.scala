...
import cn.itcast.shop.realtime.etl.utils.{CanalRowDataDeserializationSchema, KafkaProps}
import cn.ktte.shop.realtime.etl.utils.{CanalRowDataDeserializationSchema, GlobalConfigUtil, KafkaProps}
